...
<html lang="it">
  <head>
    ...
    <?php 
        ...
        favicon2();
    ?>
    <title>Collezione | Sito ufficiale FreestyleConceptStore</title>
  </head>
                ...
                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3"><h1 class="text-center text-cat">Categorie</h1></div>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                        <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" onchange="location = this.value;">
                            ...
                            <option <?php if( isset($_GET['prezzo']) && $_GET['prezzo'] == 'ASC' ){ echo 'selected';} ?> value="tutta-la-collezione?page=1&prezzo=ASC">PREZZO CRESCENTE</option>
                            <option <?php if( isset($_GET['prezzo']) && $_GET['prezzo'] == 'DESC' ){ echo 'selected';} ?> value="tutta-la-collezione?page=1&prezzo=DESC">PREZZO DECRESCENTE</option>
                            <option <?php if( isset($_GET['nome']) && $_GET['nome'] == 'ASC' ){ echo 'selected';} ?> value="tutta-la-collezione?page=1&nome=ASC">ORDINE: A-Z</option>
                            <option <?php if( isset($_GET['nome']) && $_GET['nome'] == 'DESC' ){ echo 'selected';} ?> value="tutta-la-collezione?page=1&nome=DESC">ORDINE: Z-A</option>
                            <option <?php if( isset($_GET['filtro']) && $_GET['filtro'] == 'DESC' ){ echo 'selected';} ?> value="tutta-la-collezione?page=1&filtro=DESC">ULTIMI ARRIVI</option>
                            <option <?php if( isset($_GET['insconto']) && $_GET['insconto'] == 'SI' ){ echo 'selected';} ?> value="tutta-la-collezione?page=1&insconto=SI">IN SCONTO</option>
                        </select>
                    </div>
                        ...
                        <?php
                            $a="SI";
                                ...
                                while ($row = $r->fetch_assoc()) {
                                    ...
                                    echo '
                                        <li><a class="dropdown-item" href="'.strtolower($nome).'">'.$nome.'</a></li>
                                    ';
                                }
                        ?>
                    </div>
                                    ...
                                    <?php
                                        if(isset($_GET['page'])){
                                            ...
                                            if(isset($nop)){
                                                for($i=1;$i<=$nop;$i++){
                                                    if(isset($_GET['prezzo'])){
                                                        echo '<li class="page-item"><a class="page-link" href="tutta-la-collezione?page='.$i.'&prezzo='.$_GET['prezzo'].'">'.$i.'</a></li>';
                                                    }
                                                    elseif(isset($_GET['nome'])){
                                                        echo '<li class="page-item"><a class="page-link" href="tutta-la-collezione?page='.$i.'&nome='.$_GET['nome'].'">'.$i.'</a></li>';
                                                    }
                                                    elseif(isset($_GET['filtro'])){
                                                        echo '<li class="page-item"><a class="page-link" href="tutta-la-collezione?page='.$i.'&filtro='.$_GET['filtro'].'">'.$i.'</a></li>';
                                                    }
                                                    elseif(isset($_GET['insconto'])){
                                                        echo '<li class="page-item"><a class="page-link" href="tutta-la-collezione?page='.$i.'&insconto='.$_GET['insconto'].'">'.$i.'</a></li>';
                                                    }
                                                    else{
                                                        echo '<li class="page-item"><a class="page-link" href="tutta-la-collezione?page='.$i.'">'.$i.'</a></li>';                                              
                                                    }
                                                }
                                            }   
                                        }

                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td data-label="Stato" class="t-dettagli">';?> <?php if($stato == 1) {echo '<p class="t-dettagli">Spedito<p>';}elseif($stato == 0) { echo '<p class="t-dettagli">In attesa<p>';}?> <?php echo '</td>
                                                <td data-label="C.Tracking">';?> <?php if(!empty($tracking)) {echo '<p class="text-uppercase"><a href="'.$tracking.'">'.$tracking.'</a><p>';}elseif(empty($tracking)) { echo '<p class="text-uppercase" ><ins class="text-secondary">Il codice di tracking sarà disponibile non appena il pacco sarà spedito.</ins><p>';}?> <?php echo '</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>    

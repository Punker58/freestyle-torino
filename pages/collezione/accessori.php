...
<html lang="it">
  <head>
    ...
    <?php 
        ...
        favicon2();
    ?>
    <title>Accessori | Sito ufficiale FreestyleConceptStore</title>
  </head>
        ...
        <div class="row">
          <div class="col-12">
            <div class="custom-shape-divider-bottom-1644927053">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" required>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 text-center">
                        ...
                        <form action="" method="GET">
                            <div class="input-group mb-3">
                                <input type="text" name="src" class="form-control" placeholder="" aria-label="Recipient's username" aria-describedby="button-addon2">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 text-center" style="cursor: pointer;" onclick="window.location=\'articolo-dettagli?id='.$_SESSION['articolo'].'&nome='.$nome.'\';">
                                        <div class="card gap-3 mx-4">
                                            <img class="card-img ns1" src="../../images/articoli/'.$_SESSION['categoria'].'/'.$foto0.'" alt="articolo:'.$id.'" >
                                                <div class="info">
                                                    <div class="text" onclick="window.location=\'articolo-dettagli?id='.$_SESSION['articolo'].'&nome='.$nome.'\';">
